<?php
//для подключения данного файла нужно в файле composer.json прописать в autoload    "files": [
//            "app/Helpers/helpers.php"
//        ], и запустить композер composer dump-autoload -o




//функция хелпер , которая позволяет не нагромождать php-код в шаблоне. нужна для придания класса активности ссылке присутствия  на главной странице по урлу
...
//функция хелпер , которая позволяет не нагромождать php-код в шаблоне. нужна для придания класса активности ссылке присутствия  на  странице каталога или любой статьи каталога по урлу
